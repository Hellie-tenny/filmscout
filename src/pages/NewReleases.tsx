...
export default function NewReleases() {
    ...
    const { movies, loading, error } = useNewReleases(selectedGenreId, activeTab)
    ...
    const selectGenre = (genreId: number) => {
        setSelectedGenreId((current) => (current === genreId ? null : genreId))
    }
    ...
    return (
        <div className='px-4 py-8 text-white sm:px-6 lg:px-8'>
            <h1 className='text-2xl font-bold mb-3 sm:text-3xl'>New Releases</h1>
            <p className='text-slate-300 max-w-2xl mb-6'>
                Pick a genre to see what&apos;s new and streaming right now.
            </p>
            ...
            <div className='mt-6'>
                ...
                {!error && !selectedGenreId && (
                    <div className='mt-10 flex flex-col items-center text-center text-slate-500'>
                        ...
                        <p className='text-sm'>Pick a genre to see new releases.</p>
                    </div>
                )}
                                ...
                                return (
                                    ...
                                    >
                                        <div className='relative'>
                                            ...
                                            <div className='absolute top-2 right-2 rounded-full bg-emerald-400 px-2 py-0.5 text-xs font-bold text-slate-950'>
                                                New
                                            </div>
                                        </div>
                ...
                {!error && !loading && selectedGenreId && movies.length === 0 && (
                    <div className='mt-10 flex flex-col items-center text-center text-slate-500'>
                        <SearchX className='w-10 h-10 text-slate-600 mb-3' />
                        <p className='text-sm'>No new releases found for this genre right now.</p>
                    </div>
                )}
            </div>
